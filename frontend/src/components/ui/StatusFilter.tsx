  ...
  return (
    <div className="relative w-full sm:w-auto sm:min-w-[200px]">
      <select
        ...
        className="peer w-full appearance-none bg-neutral-900 border border-neutral-700 text-neutral-200 text-sm px-3.5 py-2.5 pr-9 rounded-lg font-medium hover:border-neutral-500 focus-visible:ring-2 focus-visible:ring-white/30 focus-visible:border-neutral-500 focus:outline-none disabled:opacity-40 disabled:cursor-not-allowed transition-all duration-200 cursor-pointer"
      >
